...
elseif ($_GET["security_code"] != "e9p39xsjzfvcg4qk2gc9" || $_GET["security_code"] == ("NET2FTP_" . "SECURITY_CODE")) { 
...
$tempdir = dirname(__FILE__) . "/net2ftp_temp_w267l";
...
?>
<form name="ActionForm" action="net2ftp_installer.php?security_code=e9p39xsjzfvcg4qk2gc9" method="post">
...
<tr><td>Username</td><td><input type="text" name="username" size="25" value="joadcorptp"></td></tr>
